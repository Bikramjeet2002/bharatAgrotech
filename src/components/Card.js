...
const Card = ({ product }) => {
  return (
    <div title="Click To View Info" className="shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] h-[360px] hover:rotate-3 rounded-lg p-3">
      <Link key={product.id} href={product.href} className="group">
        <img
          alt={product.imageAlt}
          src={product.imageSrc}
          className="aspect-square w-full h-[70%] rounded-2xl bg-gray-200 object-contain group-hover:opacity-75 xl:aspect-[7/8]"
        />
        <div>
