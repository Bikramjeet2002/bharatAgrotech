      ...
      <navbar className="min-h-full z-99 bg-pink  ">
                      ...
                      <Link
                        ...
                        className={classNames(
                          item.href === pathname
                            ...
                            : "text-gray-300 hover:bg-gray-700 hover:text-white sm:text-gray-700 sm-hover:bg-white",
        ...
        {/* <div className="bg-gray-500  shadow">
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 className="text-7xl  text-center mx-auto font-extrabold  tracking-tight text-gray-900">Bharat Agro Tech</h1>
          </div>
        </div> */}
      </navbar>
    </>
